...
fun Empty(
    ...
    icon: DrawableResource = Res.drawable.deceased,
    ...
    Column(
        ...
        Text(text = stringResource(Res.string.empty), color = color)

        if (suggestion) {
            Text(text = stringResource(Res.string.suggestion), color = color)
        }
    }
}
