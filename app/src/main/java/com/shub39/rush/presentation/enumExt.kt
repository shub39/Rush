...
val allBackgrounds = if (hypnoticAvailable()) {
    listOf(
        LyricsBackground.SOLID_COLOR, LyricsBackground.ALBUM_ART, LyricsBackground.HYPNOTIC,
        LyricsBackground.WAVE, LyricsBackground.GRADIENT, LyricsBackground.CURVE
    )
} else if (blurAvailable()) {
    listOf(
        LyricsBackground.SOLID_COLOR, LyricsBackground.ALBUM_ART, LyricsBackground.WAVE,
...
val premiumCards = listOf(
    LyricsBackground.HYPNOTIC, CardTheme.MESSY, CardTheme.QUOTE, CardTheme.CHAT
)
