 ...
 * @property lyrics A list of un synchronized lyric lines, represented as a map entry of line number to text.
 * @property syncedLyrics A list of synchronized lyric objects, each containing a timestamp and text, if available.
 * @property geniusLyrics A list of lyric lines sourced from Genius, represented as a map entry of line number to text, if available.
 */
data class SongUi(
    val id: Long,
    val title: String,
